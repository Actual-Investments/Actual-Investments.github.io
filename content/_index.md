+++
title = "Actual Investments — Automated Trading"
description = "Our flagship trading bot, run hands-free on your own account with leverage from a liquidity provider."
...
<section id="verification">
  ...
  <div class="verify-grid verify-grid--single">
    <div class="verify-card">
      ...
      <!-- EDIT ME: paste your Myfxbook *widget* embed code from
           myfxbook.com/widgets in place of the placeholder below. -->
...
<section id="disclaimer" class="disclaimer">
  ...
  <p>
    ...
    and the use of leverage increases both potential gains and potential losses.
    The projection calculator is illustrative only and is not a prediction or
